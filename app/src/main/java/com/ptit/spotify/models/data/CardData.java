...
public class CardData {
    ...
    public CardData(String id, String imageUrl, String title, String description, String type) {
        this.id = id;
    ...
    public CardData(String id, String imageUrl, String title, String description, String type, boolean isSmallCard, boolean isHiddenTitle, boolean isHiddenDescription) {
        this.id = id;
        this.imageUrl = imageUrl;
        this.title = title;
        this.description = description;
